      ...
      <section className="relative bg-gradient-to-b from-black via-[#0b0005] to-black border-black py-7 text-white md:py-20 px-5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <motion.h2
            ...
            className="text-2xl sm:text-5xl font-bold text-gray-100 leading-tight"
          >
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {services.map((service, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative w-24 h-24 flex items-center justify-center rounded-2xl">
                    <div className="relative w-24 h-24 flex items-center justify-center rounded-2xl border-[7px] border-black p-[2px] bg-black">
                      <div className="w-full h-full rounded-2xl bg-gradient-to-tl from-[#FE1A88] via-[#b946f7] to-[#FE1A88] p-[0.5px]">
                        <div className="w-full h-full rounded-2xl bg-gradient-to-b from-[#2a2a2a] via-[#141414] to-[#000000] flex items-center justify-center shadow-[inset_2px_2px_6px_rgba(255,255,255,0.06),inset_-2px_-2px_10px_rgba(0,0,0,0.9),0_0_15px_4px_rgba(168,85,247,0.4)]">
                          {service.icon}
                        </div>
                      </div>
                    </div>
                ...
                >
                  <span>{openIndex === index ? "Hide Details" : "View Details"}</span>
                  <div
                ...
                <AnimatePresence>
                  {openIndex === index && (
                    <motion.div
                      key="desc"
                      initial={{ opacity: 0, height: 0, x: index % 2 === 0 ? -30 : 30 }}
                      animate={{ opacity: 1, height: "auto", x: 0 }}
                      exit={{ opacity: 0, height: 0, x: index % 2 === 0 ? -30 : 30 }}
