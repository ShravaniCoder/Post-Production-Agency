...
<section className="relative bg-black text-white md:py-10 px-4 sm:px-6 lg:px-12 overflow-hidden">
  ...
  {/* 🌙 Natural subtle gradient glows */}
  <div className="absolute inset-0">
    {/* Gentle top-left pinkish glow */}
    ...
    {/* Gentle bottom-right purplish glow */}
  ...
  <div className="relative max-w-7xl mx-auto z-10">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-center">
      ...
      {/* Location Card */}
      <div className="relative bg-[#141414] p-8 rounded-xl shadow-md text-center border border-[#2a2a2a]/60">
  ...
  {/* Google Map */}
  <div className="relative max-w-7xl mt-9 mx-auto rounded-xl overflow-hidden shadow-[0_0_25px_rgba(254,26,136,0.12)] h-[300px] sm:h-[400px] lg:h-[450px] z-10">
    <iframe
...
<section className="relative bg-black text-white py-10 px-4 sm:px-6 lg:px-12 overflow-hidden">
  ...
  {/* 🌈 Natural gradient glows */}
  <div className="absolute inset-0 pointer-events-none">
    {/* Top-left glow (pinkish tone) */}
  ...
  {/* Form */}
  <form className="relative max-w-3xl mx-auto space-y-4 z-10">
